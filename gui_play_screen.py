...
class Pause_button():
    def __init__(self, x, y, w, h):
        self.surface_pause = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\btn/pause.png")
        self.surface_pause = pygame.transform.scale(self.surface_pause,(w, h))
        self.surface_play = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\btn/play.png")
...
class Score():
    def __init__(self, x_back, y_back, w_back, h_back, w_number, h_number):
        self.image_back = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle/bubble/table.png")
        ...
        self.image_score = pygame.image.load(r"C:\Users\vilan\Desktop\images/score.png")
        ...
        self.numbers_list = []
        self.image_number_zero = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/0.png")
        self.image_number_zero = pygame.transform.scale(self.image_number_zero, (w_number, h_number))
        self.image_number_one = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/1.png")
        self.image_number_one = pygame.transform.scale(self.image_number_one, (w_number, h_number))
        self.image_number_two = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/2.png")
        self.image_number_two = pygame.transform.scale(self.image_number_two, (w_number, h_number))
        self.image_number_three = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/3.png")
        self.image_number_three = pygame.transform.scale(self.image_number_three, (w_number, h_number))
        self.image_number_four = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/4.png")
        self.image_number_four = pygame.transform.scale(self.image_number_four, (w_number, h_number))
        self.image_number_five = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/5.png")
        self.image_number_five = pygame.transform.scale(self.image_number_five, (w_number, h_number))
        self.image_number_six = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/6.png")
        self.image_number_six = pygame.transform.scale(self.image_number_six, (w_number, h_number))
        self.image_number_seven = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/7.png")
        self.image_number_seven = pygame.transform.scale(self.image_number_seven, (w_number, h_number))
        self.image_number_eight = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/8.png")
        self.image_number_eight = pygame.transform.scale(self.image_number_eight, (w_number, h_number))
        self.image_number_nine = pygame.image.load(r"C:\Users\vilan\Desktop\images_completisimo\images\gui\jungle\bubble/9.png")
