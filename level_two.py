...
def create_level_two():
    ...
    imagen_fondo = pygame.image.load(r"C:\Users\vilan\OneDrive\Escritorio\images_completisimo\images\locations\set_bg_05\2_game_background/2_game_background.png").convert()
    imagen_fondo = pygame.transform.scale(imagen_fondo,(ANCHO_VENTANA,ALTO_VENTANA))
    rewards_list = create_rewards("C:/Users/vilan/OneDrive/Escritorio/images_completisimo/images/food/apple/apple__x1_iconic_png_1354829396")
